...
public class GetMyQuizResponse {
    ...
    private Integer answerId; // 答题内容ID

    public GetMyQuizResponse(String status, String message, Integer quizId, String title, String subject,
                             String difficulty, Date createTime, Date deadline, String teacherName,
                             String teacherId, Integer quizStatus, Integer score, String feedback,Integer answerId) {
