...
public class AdminController {
    ...
    //注销账户
    @PostMapping("/delete")
    public ResponseEntity<?> deleteUser(@RequestParam("userType") Integer userType, @RequestParam("userId") String userId) {
        if (userType!=0)
        {
    ...
    @PostMapping("/update")
    public ResponseEntity<?> updateUser(@RequestParam("userId") String userId, @RequestParam("newUserName") String newUserName,
                                        @RequestParam("newEmail") String newEmail, @RequestParam("newPassword") String newPassword) {
    ...
    public ResponseEntity<?> updateStudentClass(@RequestParam("studentId") String studentId, @RequestParam("newClassId") String newClassId) {
    ...
    public ResponseEntity<?> updateTeacherClass(@RequestParam("teacherId") String teacherId, @RequestParam("newClass1") String newClass1,@RequestParam("newClass2") String newClass2) {
    ...
    public ResponseEntity<?> updateTeacherSubject(@RequestParam("teacherId") String teacherId, @RequestParam("newSubject") String newSubject) {
